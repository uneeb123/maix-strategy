...
def create_position(position_id: int, entry_price: float, entry_time: datetime, size: float) -> Position:
...
def trade_strategy(data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    Returns:
        Dictionary with 'action' ('buy', 'sell', 'hold') and 'info'
    """
    ...
    # This is a simplified version - you would implement your actual strategy here
    
    # Example: Buy if price is above moving average and volume is high
    if len(lookback) >= 20:
...
def should_sell_position(data: Dict[str, Any]) -> Dict[str, Any]:
    """
